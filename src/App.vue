  ...
  <div id="app">
    <v-app id="inspire">
      <v-content class="mt-6">
        <v-container>
          <h3 class="text-center" style="color: indigo">Pencarian User App</h3>
          <v-card
                  class="mx-auto mt-4"
                  max-width="344"
                  outlined
            ...
            <v-list-item>
              <v-list-item-content>
                <v-list-item-title class="align-center">
                  ...
                  <div style="font-weight: bold">Pilih Platform yang ingin dicari</div>
      ...
      <v-footer height="auto" color="indigo" dark>
        <v-layout justify-center row wrap>
          <v-flex color="indigo" dark py-3 text-xs-center text-md-center text-sm-center white--text xs12>
            <strong>Dev by PTP H8 <a target="_blank" href="https://hacktiv8.com"><span class=" style-name">@hacktiv8PTP</span></a> &copy; {{ new Date().getFullYear() }}</strong>
          </v-flex>
        </v-layout>
      </v-footer>
    </v-app>
